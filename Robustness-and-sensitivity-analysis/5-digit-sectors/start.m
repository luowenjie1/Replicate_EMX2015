...
N  = 300;          % maximum number of producers per sector
...
xi_x  = 5.7;                                % Pareto shape, idiosyncratic productivity
xi_z  = 0.505927117530769;                  % Pareto shape, sector productivity      
zeta  = 0.02;                               % geometric parameter, number producers per sector
FD    = 1e-7;                               % fixed cost of domestic operations
FX    = 0.049;                              % fixed cost of export operations
tau   = 0.13;                               % net trade cost 
rho   = 0.913;                              % Kendall correlation for Gumbel copula 
