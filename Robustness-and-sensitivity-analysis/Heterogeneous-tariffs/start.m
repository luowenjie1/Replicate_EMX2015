...
FX    = 0.055;                              % fixed cost of export operations
tau   = 0.055;                              % net trade cost 
rho   = 0.940;                              % Kendall correlation for Gumbel copula 


% Tariff Distribution

tariff_a    = 2.3;                          % tariffs distributed Beta(tarrif_a,tariff_b) on [0,1] 
tariff_b    = 35;                           % mean tariff = a/(a+b), variance = a*b/(((a+b)^2)*(a+b+1))
