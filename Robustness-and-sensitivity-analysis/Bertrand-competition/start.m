...
N  = 283;          % maximum number of producers per sector


% Calibrated Parameters

gamma = 10.4971041171121;                   % within-sector elasticity of substitution   
theta = (1/gamma - b1/b0*(1-1/gamma))^(-1); % across-sector elasticity of substitution, *ensures same theta as Benchmark model*
xi_x  = 4.52913480749976;                   % Pareto shape, idiosyncratic productivity
xi_z  = 0.563765765444829;                  % Pareto shape, sector productivity      
zeta  = 0.042696050528774;                  % geometric parameter, number producers per sector
FD    = 0.00427708030347627;                % fixed cost of domestic operations
FX    = 0.110;                              % fixed cost of export operations
tau   = 0.132;                              % net trade cost 
rho   = 0.9075;                             % Kendall correlation for Gumbel copula 
