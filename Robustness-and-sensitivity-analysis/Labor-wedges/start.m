...
FX    = 0.065;                             % fixed cost of export operations
tau   = 0.1286;                             % net trade cost 
rho   = 0.932;                           % Kendall correlation for Gumbel copula 

% Labor Wedge 

ltau  = 0.001;                              % controls sensitivity of labor wedge to productivity
