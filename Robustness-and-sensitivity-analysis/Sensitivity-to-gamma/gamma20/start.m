...
gamma = 20;                                 % within-sector elasticity of substitution   
...
FX    = 0.04;                               % fixed cost of export operations
tau   = 0.138;                              % net trade cost 
rho   = 0.9204;                             % Kendall correlation for Gumbel copula 
