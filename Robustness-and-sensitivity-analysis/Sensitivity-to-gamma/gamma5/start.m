...
gamma = 5;                                  % within-sector elasticity of substitution   
...
FX    = 1.35;                               % fixed cost of export operations
tau   = 0.08;                               % net trade cost 
rho   = 0.999;                              % Kendall correlation for Gumbel copula 
