...
nmu = 15; % number of different values of mu we search over (this is actually mu/(theta-1) where mu is the tail of the productivity distribution)
...
data    = [wi.*n1, tsales1, tlabor1; wi.*n2, tsales2, tlabor2]; 
...
sales_s = n1.*tsales1 + n2.*tsales2;
labor_s = n1.*tlabor1 + n2.*tlabor2;
...
all_model_moments = [Block1, Block2, Block3, Block4, Block5, Block6, Block7]';
